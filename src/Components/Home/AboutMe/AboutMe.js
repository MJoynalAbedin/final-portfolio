                    ...
                    <div className="row p-5">
                        ...
                        <div className="col-md-7 align-self-center mt-2">
                            ...
                            <p className="text-secondary my-5">
                                As you've already known who I am in brief. Starting with my background, I live at Chattogram town in Bangladesh. I am a learner rather being a student and that makes me learn something new everyday.
                            <br /><br />
                            I was passionate about coding since I watched 'Iron Man' movie and I have got directly involved in coding a year ago. I am almost an expert in Basic HTML, CSS and a framework, Bootstrap, React JS, Firebase, Node JS, MongoDB etc as I have completed more than 6 projects with them. You can see each and every of my skills in my resume.
                        </p>
